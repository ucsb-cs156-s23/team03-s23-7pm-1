            ...
            <Nav className="mr-auto">
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Parks" id="appnavbar-parks-dropdown" data-testid="appnavbar-parks-dropdown" >
                    <NavDropdown.Item href="/parks" data-testid="appnavbar-parks-list">List Parks</NavDropdown.Item>
                    <NavDropdown.Item href="/parks/create" data-testid="appnavbar-parks-create">Create Parks</NavDropdown.Item>
                  </NavDropdown>
                )
              }
            </Nav>
